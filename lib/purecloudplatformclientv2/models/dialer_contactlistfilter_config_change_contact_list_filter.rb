...
module PureCloud
  class DialerContactlistfilterConfigChangeContactListFilter
    ...
    attr_accessor :contact_list_columns
    ...
    def self.swagger_types
      {
        ...
        :'clauses' => :'Array<DialerContactlistfilterConfigChangeFilterClause>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contactListColumns')
        
        if (value = attributes[:'contactListColumns']).is_a?(Array)
          self.contact_list_columns = value
        end
    ...
    def filter_type=(filter_type)
      allowed_values = ["AND", "OR"]
      if filter_type && !allowed_values.include?(filter_type)
        fail ArgumentError, "invalid value for 'filter_type', must be one of #{allowed_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          contact_list_columns == o.contact_list_columns &&
          clauses == o.clauses &&
    ...
    def hash
      [id, name, date_created, date_modified, version, contact_list, contact_list_columns, clauses, filter_type, additional_properties].hash
    end

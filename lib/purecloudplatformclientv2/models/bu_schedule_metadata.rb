...
module PureCloud
  class BuScheduleMetadata
    ...
    def self.swagger_types
      {
        ...
        :'management_units' => :'Array<BuManagementUnitScheduleSummary>',
    ...
    def hash
      [id, week_date, week_count, description, published, short_term_forecast, generation_results, metadata, management_units, self_uri].hash
    end

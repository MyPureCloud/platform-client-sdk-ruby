...
module PureCloud
  class DivsPermittedEntityListing
    ...
    attr_accessor :all_divs_permitted
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allDivsPermitted')
        
        
        self.all_divs_permitted = attributes[:'allDivsPermitted']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          total == o.total &&
          all_divs_permitted == o.all_divs_permitted &&
    ...
    def hash
      [entities, page_size, page_number, total, all_divs_permitted, first_uri, self_uri, next_uri, last_uri, previous_uri, page_count].hash
    end

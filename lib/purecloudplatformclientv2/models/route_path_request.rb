...
module PureCloud
  ...
  class RoutePathRequest
    ...
    attr_accessor :source_planning_group
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sourcePlanningGroup')
        
        
        self.source_planning_group = attributes[:'sourcePlanningGroup']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          source_planning_group == o.source_planning_group
    end
    ...
    def hash
      [queue_id, media_type, language_id, skill_ids, source_planning_group].hash
    end

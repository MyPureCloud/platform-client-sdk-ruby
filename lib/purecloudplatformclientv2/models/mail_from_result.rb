...
module PureCloud
  class MailFromResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mailFromDomain')
        
        
        self.mail_from_domain = attributes[:'mailFromDomain']
    ...
    def hash
      [status, records, mail_from_domain].hash
    end

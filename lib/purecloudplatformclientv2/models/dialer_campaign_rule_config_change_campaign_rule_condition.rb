...
module PureCloud
  class DialerCampaignRuleConfigChangeCampaignRuleCondition
    attr_accessor :id
    ...
    def condition_type=(condition_type)
      allowed_values = ["CAMPAIGN_PROGRESS", "CAMPAIGN_AGENTS"]
      if condition_type && !allowed_values.include?(condition_type)
        fail ArgumentError, "invalid value for 'condition_type', must be one of #{allowed_values}."
      end
    ...
    def hash
      [id, parameters, condition_type, additional_properties].hash
    end

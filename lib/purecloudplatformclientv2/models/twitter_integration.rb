...
module PureCloud
  class TwitterIntegration
    ...
    def hash
      [id, name, access_token_key, consumer_key, username, user_id, status, tier, env_name, recipient, date_created, date_modified, created_by, modified_by, version, self_uri].hash
    end

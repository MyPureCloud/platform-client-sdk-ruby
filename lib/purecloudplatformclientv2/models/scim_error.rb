...
module PureCloud
  ...
  class ScimError
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'scimType')
        
        
        self.scim_type = attributes[:'scimType']
    ...
    def valid?
      ...
      if @scim_type && !allowed_values.include?(@scim_type)
        return false
      end
    ...
    # @param [Object] scim_type Object to be assigned
    def scim_type=(scim_type)
      allowed_values = ["invalidFilter", "tooMany", "uniqueness", "mutability", "invalidSyntax", "invalidPath", "noTarget", "invalidValue", "invalidVers", "sensitive"]
      if scim_type && !allowed_values.include?(scim_type)
        fail ArgumentError, "invalid value for 'scim_type', must be one of #{allowed_values}."
      end
      @scim_type = scim_type
    end
    ...
    def hash
      [status, scim_type, detail, schemas].hash
    end

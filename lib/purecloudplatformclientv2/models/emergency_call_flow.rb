...
module PureCloud
  ...
  class EmergencyCallFlow
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'emergencyFlow')
        
        
        self.emergency_flow = attributes[:'emergencyFlow']
        
      
      end

      
      if attributes.has_key?(:'ivrs')
        
        if (value = attributes[:'ivrs']).is_a?(Array)
          self.ivrs = value
        end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          emergency_flow == o.emergency_flow &&
          ivrs == o.ivrs
    end

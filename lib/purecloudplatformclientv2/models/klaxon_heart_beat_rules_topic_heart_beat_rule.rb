...
module PureCloud
  class KlaxonHeartBeatRulesTopicHeartBeatRule
    ...
    def self.swagger_types
      {
        ...
        :'notification_users' => :'Array<KlaxonHeartBeatRulesTopicNotificationUser>',
    ...
    def hash
      [id, name, sender_id, heart_beat_timeout_in_minutes, enabled, in_alarm, notification_users, alert_types, rule_type].hash
    end

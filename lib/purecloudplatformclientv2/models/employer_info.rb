...
module PureCloud
  class EmployerInfo
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dateHire')
        
        
        self.date_hire = attributes[:'dateHire']
    ...
    def hash
      [official_name, employee_id, employee_type, date_hire].hash
    end

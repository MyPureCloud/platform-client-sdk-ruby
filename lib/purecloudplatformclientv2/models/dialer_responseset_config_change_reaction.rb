...
module PureCloud
  class DialerResponsesetConfigChangeReaction
    attr_accessor :data
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reactionType')
        
        
        self.reaction_type = attributes[:'reactionType']
    ...
    def hash
      [data, name, reaction_type, additional_properties].hash
    end

...
module PureCloud
  class ManagementUnitListing
    ...
    def hash
      [entities, page_size, page_number, total, first_uri, next_uri, page_count, last_uri, previous_uri, self_uri].hash
    end

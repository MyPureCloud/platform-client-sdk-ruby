...
module PureCloud
  class WfmBuScheduleTopicBuScheduleMetadata
    attr_accessor :id
    ...
    def self.swagger_types
      {
        ...
        :'management_units' => :'Array<WfmBuScheduleTopicBuManagementUnitScheduleSummary>',
    ...
    def hash
      [id, week_date, week_count, description, published, short_term_forecast, management_units, generation_results, metadata].hash
    end

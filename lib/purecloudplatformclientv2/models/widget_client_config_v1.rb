...
module PureCloud
  class WidgetClientConfigV1
    attr_accessor :web_chat_skin
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'webChatSkin')
        
        
        self.web_chat_skin = attributes[:'webChatSkin']
    ...
    def hash
      [web_chat_skin, authentication_url].hash
    end

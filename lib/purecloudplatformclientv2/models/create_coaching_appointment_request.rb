...
module PureCloud
  ...
  class CreateCoachingAppointmentRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'facilitatorId')
        
        
        self.facilitator_id = attributes[:'facilitatorId']
        
      
      end

      
      if attributes.has_key?(:'attendeeIds')
        
        if (value = attributes[:'attendeeIds']).is_a?(Array)
          self.attendee_ids = value
        end
    ...
    def hash
      [name, description, date_start, length_in_minutes, facilitator_id, attendee_ids, conversation_ids, document_ids].hash
    end

...
module PureCloud
  class BuIntradayResponse
    ...
    def self.swagger_types
      {
        ...
        :'intraday_data_groupings' => :'Array<BuIntradayDataGroup>'
    ...
    def hash
      [start_date, end_date, interval_length_minutes, no_data_reason, categories, short_term_forecast, schedule, intraday_data_groupings].hash
    end

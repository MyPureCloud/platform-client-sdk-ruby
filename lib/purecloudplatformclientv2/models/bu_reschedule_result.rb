...
module PureCloud
  class BuRescheduleResult
    ...
    attr_accessor :generation_results_download_url
    ...
    attr_accessor :headcount_forecast_download_url
    ...
    def self.swagger_types
      {
        ...
        :'generation_results_download_url' => :'String',
        
        :'headcount_forecast' => :'BuHeadcountForecast',
        
        :'headcount_forecast_download_url' => :'String',
        
        :'agent_schedules' => :'Array<BuRescheduleAgentScheduleResult>'
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'generationResultsDownloadUrl')
        
        
        self.generation_results_download_url = attributes[:'generationResultsDownloadUrl']
      ...
      if attributes.has_key?(:'headcountForecastDownloadUrl')
        
        
        self.headcount_forecast_download_url = attributes[:'headcountForecastDownloadUrl']
        
      
      end

      
      if attributes.has_key?(:'agentSchedules')
        
        if (value = attributes[:'agentSchedules']).is_a?(Array)
          self.agent_schedules = value
        end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          generation_results_download_url == o.generation_results_download_url &&
          headcount_forecast == o.headcount_forecast &&
          headcount_forecast_download_url == o.headcount_forecast_download_url &&
    ...
    def hash
      [generation_results, generation_results_download_url, headcount_forecast, headcount_forecast_download_url, agent_schedules].hash
    end

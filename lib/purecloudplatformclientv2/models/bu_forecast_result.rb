  ...
  class BuForecastResult
    ...
    def self.swagger_types
      {
        ...
        :'planning_groups' => :'Array<ForecastPlanningGroupData>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'planningGroups')
        ...
        if (value = attributes[:'planningGroups']).is_a?(Array)
          self.planning_groups = value
        end
      ...
      if attributes.has_key?(:'weekNumber')
        
        
        self.week_number = attributes[:'weekNumber']
    ...
    def hash
      [reference_start_date, planning_groups, week_number, week_count].hash
    end

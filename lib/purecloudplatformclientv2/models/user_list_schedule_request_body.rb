...
module PureCloud
  ...
  class UserListScheduleRequestBody
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'loadFullWeeks')
        
        
        self.load_full_weeks = attributes[:'loadFullWeeks']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          end_date == o.end_date &&
          load_full_weeks == o.load_full_weeks
    end
    ...
    def hash
      [user_ids, start_date, end_date, load_full_weeks].hash
    end

...
module PureCloud
  ...
  class BusinessUnitActivityCode
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'defaultCode')
        
        
        self.default_code = attributes[:'defaultCode']
    ...
    def hash
      [id, name, active, default_code, category, length_in_minutes, counts_as_paid_time, counts_as_work_time, agent_time_off_selectable, metadata, self_uri].hash
    end

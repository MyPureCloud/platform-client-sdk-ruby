...
module PureCloud
  class IntradayPerformancePredictionData
    ...
    attr_accessor :occupancy_percent
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'occupancyPercent')
        
        
        self.occupancy_percent = attributes[:'occupancyPercent']
    ...
    def hash
      [service_level_percent, average_speed_of_answer_seconds, occupancy_percent].hash
    end

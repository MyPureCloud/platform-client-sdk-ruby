...
module PureCloud
  class SearchShiftTradeResponse
    ...
    attr_accessor :matching_receiving_shift_ids
    ...
    def self.swagger_types
      {
        ...
        :'matching_receiving_shift_ids' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'matchingReceivingShiftIds')
        
        if (value = attributes[:'matchingReceivingShiftIds']).is_a?(Array)
          self.matching_receiving_shift_ids = value
        end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          trade == o.trade &&
          matching_receiving_shift_ids == o.matching_receiving_shift_ids &&
          preview == o.preview
    end
    ...
    def hash
      [trade, matching_receiving_shift_ids, preview].hash
    end

...
module PureCloud
  class WfmUserNotificationTopicTimeOffRequestNotification
    ...
    def self.swagger_types
      {
        ...
        :'user' => :'WfmUserNotificationTopicUserReference',
    ...
    def hash
      [time_off_request_id, user, is_full_day_request, status, partial_day_start_date_times, full_day_management_unit_dates].hash
    end

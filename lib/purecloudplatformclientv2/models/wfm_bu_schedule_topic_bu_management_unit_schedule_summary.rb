...
module PureCloud
  class WfmBuScheduleTopicBuManagementUnitScheduleSummary
    ...
    def self.swagger_types
      {
        ...
        :'agents' => :'Array<WfmBuScheduleTopicUserReference>',
    ...
    def hash
      [management_unit, start_date, end_date, agents, agent_count].hash
    end

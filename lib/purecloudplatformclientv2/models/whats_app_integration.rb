...
module PureCloud
  class WhatsAppIntegration
    ...
    attr_accessor :activation_status_code

    # The error information of WhatsApp Integration activation process
    attr_accessor :activation_error_info
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'activationStatusCode')
        
        
        self.activation_status_code = attributes[:'activationStatusCode']
        
      
      end

      
      if attributes.has_key?(:'activationErrorInfo')
        
        
        self.activation_error_info = attributes[:'activationErrorInfo']
    ...
    def valid?
      ...
      if @activation_status_code && !allowed_values.include?(@activation_status_code)
        return false
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] activation_status_code Object to be assigned
    def activation_status_code=(activation_status_code)
      allowed_values = ["CodeSent", "WaitRequired", "ActivationFailed", "CodeConfirmed", "ConfirmationFailed", "ResendCode"]
      if activation_status_code && !allowed_values.include?(activation_status_code)
        fail ArgumentError, "invalid value for 'activation_status_code', must be one of #{allowed_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          version == o.version &&
          activation_status_code == o.activation_status_code &&
          activation_error_info == o.activation_error_info &&
          self_uri == o.self_uri
    end
    ...
    def hash
      [id, name, phone_number, status, recipient, date_created, date_modified, created_by, modified_by, version, activation_status_code, activation_error_info, self_uri].hash
    end

...
module PureCloud
  class SegmentAssignedEvent
    ...
    def hash
      [segment, user_agent_string, browser, device, geolocation, ip_address, ip_organization, mkt_campaign, visit_referrer, visit_created_date].hash
    end

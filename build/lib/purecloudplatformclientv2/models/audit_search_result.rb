...
module PureCloud
  class AuditSearchResult
    ...
    attr_accessor :facet_info

    attr_accessor :audit_messages
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          facet_info == o.facet_info &&
          audit_messages == o.audit_messages
    end
    ...
    def hash
      [page_number, page_size, total, page_count, facet_info, audit_messages].hash
    end

...
module PureCloud
  class ForecastTimeSeriesResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'forecastingMethod')
        
        
        self.forecasting_method = attributes[:'forecastingMethod']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          metric == o.metric &&
          forecasting_method == o.forecasting_method
    end
    ...
    def hash
      [metric, forecasting_method].hash
    end

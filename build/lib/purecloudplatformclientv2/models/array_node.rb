...
module PureCloud
  class ArrayNode
    ...
    def hash
      [node_type, object, float, number, boolean, value_node, container_node, missing_node, pojo, floating_point_number, integral_number, short, int, long, double, big_decimal, big_integer, textual, binary, array, null].hash
    end

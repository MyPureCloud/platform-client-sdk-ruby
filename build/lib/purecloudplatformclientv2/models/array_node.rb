...
module PureCloud
  class ArrayNode
    ...
    def hash
      [node_type, float, number, object, boolean, missing_node, value_node, binary, pojo, container_node, int, integral_number, short, long, floating_point_number, double, big_decimal, big_integer, textual, array, null].hash
    end

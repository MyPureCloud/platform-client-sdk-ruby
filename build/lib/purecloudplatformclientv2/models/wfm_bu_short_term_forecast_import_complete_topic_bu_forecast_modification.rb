...
module PureCloud
  class WfmBuShortTermForecastImportCompleteTopicBuForecastModification
    attr_accessor :type
    ...
    def self.swagger_types
      {
        ...
        :'values' => :'Array<WfmBuShortTermForecastImportCompleteTopicModificationIntervalOffsetValue>',
    ...
    def hash
      [type, start_interval_index, end_interval_index, metric, legacy_metric, value, values, enabled, granularity, display_granularity, planning_group_ids].hash
    end

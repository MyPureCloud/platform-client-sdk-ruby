...
module PureCloud
  class ConversationNotificationScreenshare
    attr_accessor :state
    ...
    def hash
      [state, _self, id, context, sharing, provider, script_id, disconnect_type, connected_time, disconnected_time, additional_properties].hash
    end

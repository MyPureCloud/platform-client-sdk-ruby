...
module PureCloud
  class EdgeTrunkBase
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, trunk_metabase, properties, trunk_type, self_uri].hash
    end

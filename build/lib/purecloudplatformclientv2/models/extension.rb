...
module PureCloud
  class Extension
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'extensionPool')
        
        
        self.extension_pool = attributes[:'extensionPool']
    ...
    def valid?
      ...
      if @owner_type && !allowed_values.include?(@owner_type)
        return false
      end
    ...
    def owner_type=(owner_type)
      allowed_values = ["USER", "PHONE", "IVR_CONFIG", "GROUP"]
      if owner_type && !allowed_values.include?(owner_type)
        fail ArgumentError, "invalid value for 'owner_type', must be one of #{allowed_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          number == o.number &&
          owner == o.owner &&
          extension_pool == o.extension_pool &&
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, number, owner, extension_pool, owner_type, self_uri].hash
    end

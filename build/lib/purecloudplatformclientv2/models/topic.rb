...
module PureCloud
  class Topic
    ...
    def self.swagger_types
      {
        ...
        :'programs' => :'Array<BaseProgramEntity>',
    ...
    def hash
      [id, name, description, applied, strictness, programs, tags, dialect, participants, phrases, modified_by, date_modified, self_uri].hash
    end

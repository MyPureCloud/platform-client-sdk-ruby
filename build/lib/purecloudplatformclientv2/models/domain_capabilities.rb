...
module PureCloud
  class DomainCapabilities
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'autoMetric')
        
        
        self.auto_metric = attributes[:'autoMetric']
        
      
      end

      
      if attributes.has_key?(:'supportsMetric')
        
        
        self.supports_metric = attributes[:'supportsMetric']
        
      
      end

      
      if attributes.has_key?(:'pingEnabled')
        
        
        self.ping_enabled = attributes[:'pingEnabled']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dhcp == o.dhcp &&
          metric == o.metric &&
          auto_metric == o.auto_metric &&
          supports_metric == o.supports_metric &&
          ping_enabled == o.ping_enabled
    end
    ...
    def hash
      [enabled, dhcp, metric, auto_metric, supports_metric, ping_enabled].hash
    end

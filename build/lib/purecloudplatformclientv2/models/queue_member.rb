...
module PureCloud
  class QueueMember
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'memberBy')
        
        
        self.member_by = attributes[:'memberBy']
    ...
    def hash
      [id, name, user, ring_number, joined, member_by, routing_status, self_uri].hash
    end

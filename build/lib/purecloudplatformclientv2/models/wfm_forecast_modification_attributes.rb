...
module PureCloud
  class WfmForecastModificationAttributes
    ...
    def self.swagger_types
      {
        ...
        :'skill_sets' => :'Array<Array<RoutingSkillReference>>'
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'skillSets')
        
        if (value = attributes[:'skillSets']).is_a?(Array)
          self.skill_sets = value
        end
    ...
    def hash
      [queues, media_types, languages, skill_sets].hash
    end

...
module PureCloud
  class MessagingSticker
    ...
    attr_accessor :provider_sticker_id

    # The package Id of the sticker, assigned by the sticker provider.
    attr_accessor :provider_package_id
    ...
    def self.swagger_types
      {
        ...
        :'provider_sticker_id' => :'Integer',
        
        :'provider_package_id' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'providerStickerId')
        
        
        self.provider_sticker_id = attributes[:'providerStickerId']
        
      
      end

      
      if attributes.has_key?(:'providerPackageId')
        
        
        self.provider_package_id = attributes[:'providerPackageId']
        
      
      end

      
      if attributes.has_key?(:'packageName')
      ...
      if attributes.has_key?(:'stickerType')
        
        
        self.sticker_type = attributes[:'stickerType']
      ...
      if attributes.has_key?(:'uriLocation')
        
        
        self.uri_location = attributes[:'uriLocation']
    ...
    def valid?
      ...
      if @sticker_type && !allowed_values.include?(@sticker_type)
        return false
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] sticker_type Object to be assigned
    def sticker_type=(sticker_type)
      allowed_values = ["standard", "free", "paid"]
      if sticker_type && !allowed_values.include?(sticker_type)
        fail ArgumentError, "invalid value for 'sticker_type', must be one of #{allowed_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          name == o.name &&
          provider_sticker_id == o.provider_sticker_id &&
          provider_package_id == o.provider_package_id &&
          package_name == o.package_name &&
          messenger_type == o.messenger_type &&
          sticker_type == o.sticker_type &&
    ...
    def hash
      [id, name, provider_sticker_id, provider_package_id, package_name, messenger_type, sticker_type, provider_version, uri_location, self_uri].hash
    end

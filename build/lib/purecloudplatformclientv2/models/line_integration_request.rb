  ...
  class LineIntegrationRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'switcherSecret')
        ...
        self.switcher_secret = attributes[:'switcherSecret']
    ...
    def hash
      [id, name, channel_id, channel_secret, switcher_secret, service_code, self_uri].hash
    end

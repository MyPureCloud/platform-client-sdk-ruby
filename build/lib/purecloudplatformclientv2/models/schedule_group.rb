...
module PureCloud
  ...
  class ScheduleGroup
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'openSchedules')
        
        if (value = attributes[:'openSchedules']).is_a?(Array)
          self.open_schedules = value
        end
      ...
      if attributes.has_key?(:'closedSchedules')
        
        if (value = attributes[:'closedSchedules']).is_a?(Array)
          self.closed_schedules = value
        end

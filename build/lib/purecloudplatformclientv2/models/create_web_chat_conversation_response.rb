...
module PureCloud
  class CreateWebChatConversationResponse
    ...
    attr_accessor :event_stream_uri
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'eventStreamUri')
        
        
        self.event_stream_uri = attributes[:'eventStreamUri']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          jwt == o.jwt &&
          event_stream_uri == o.event_stream_uri &&
          member == o.member
    end
    ...
    def hash
      [id, jwt, event_stream_uri, member].hash
    end

...
module PureCloud
  class OrganizationPresence
    ...
    def self.swagger_types
      {
        ...
        :'language_labels' => :'Hash<String, String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'languageLabels')
        
        if (value = attributes[:'languageLabels']).is_a?(Array)
          self.language_labels = value
        end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          name == o.name &&
          language_labels == o.language_labels &&
    ...
    def hash
      [id, name, language_labels, system_presence, deactivated, primary, created_by, created_date, modified_by, modified_date, self_uri].hash
    end

...
module PureCloud
  class Cobrowsesession
    ...
    def hash
      [state, id, disconnect_type, _self, cobrowse_session_id, cobrowse_role, controlling, viewer_url, provider_event_time, start_alerting_time, connected_time, disconnected_time, provider, peer_id, segments, wrapup, after_call_work].hash
    end

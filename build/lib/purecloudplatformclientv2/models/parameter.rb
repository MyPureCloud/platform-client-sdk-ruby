...
module PureCloud
  class Parameter
    ...
    def parameter_type=(parameter_type)
      allowed_values = ["UUID", "STRING", "UUIDLIST", "STRINGLIST"]
      if parameter_type && !allowed_values.include?(parameter_type)
        fail ArgumentError, "invalid value for 'parameter_type', must be one of #{allowed_values}."
      end
    ...
    def domain=(domain)
      allowed_values = ["USERID", "QUEUEID", "MEDIATYPE", "DIALERCAMPAIGNID", "QMEVALFORMID", "UNKNOWN"]
      if domain && !allowed_values.include?(domain)
        fail ArgumentError, "invalid value for 'domain', must be one of #{allowed_values}."
      end
      @domain = domain
    end
    ...
    def hash
      [name, parameter_type, domain, required].hash
    end

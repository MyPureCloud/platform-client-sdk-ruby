...
module PureCloud
  class FaxDataV2Notification
    ...
    def self.swagger_types
      {
        ...
        :'uploaded_by' => :'FaxDataV2NotificationUserData',
        
        :'lock_info' => :'FaxDataV2NotificationLockInfo',
    ...
    def hash
      [id, name, date_created, date_modified, workspace, created_by, content_type, content_length, filename, change_number, date_uploaded, uploaded_by, lock_info, self_uri, caller_address, receiver_address, read].hash
    end

...
module PureCloud
  class LineBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lineMetaBase')
        
        
        self.line_meta_base = attributes[:'lineMetaBase']
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, line_meta_base, properties, self_uri].hash
    end

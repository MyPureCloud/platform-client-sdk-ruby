...
module PureCloud
  class InteractionStatsRule
    ...
    def hash
      [id, name, dimension, dimension_value, metric, media_type, numeric_range, statistic, value, enabled, in_alarm, notification_users, alert_types, self_uri].hash
    end

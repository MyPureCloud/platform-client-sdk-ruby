...
module PureCloud
  class TrunkMetricsOptions
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'optionState')
        
        
        self.option_state = attributes[:'optionState']
        
      
      end

      
      if attributes.has_key?(:'optionStateTime')
        
        
        self.option_state_time = attributes[:'optionStateTime']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          option_state == o.option_state &&
          option_state_time == o.option_state_time &&
    ...
    def hash
      [proxy_address, option_state, option_state_time, error_info].hash
    end

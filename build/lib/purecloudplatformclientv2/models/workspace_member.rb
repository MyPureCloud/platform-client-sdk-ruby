...
module PureCloud
  class WorkspaceMember
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'securityProfile')
        
        
        self.security_profile = attributes[:'securityProfile']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user == o.user &&
          group == o.group &&
          security_profile == o.security_profile &&
          self_uri == o.self_uri
    end
    ...
    def hash
      [id, name, workspace, member_type, member, user, group, security_profile, self_uri].hash
    end

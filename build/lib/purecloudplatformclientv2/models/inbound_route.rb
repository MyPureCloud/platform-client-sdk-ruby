...
module PureCloud
  class InboundRoute
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'autoBcc')
        
        if (value = attributes[:'autoBcc']).is_a?(Array)
          self.auto_bcc = value
        end
      ...
      if attributes.has_key?(:'spamFlow')
        
        
        self.spam_flow = attributes[:'spamFlow']
    ...
    def hash
      [id, name, pattern, queue, priority, skills, language, from_name, from_email, flow, reply_email_address, auto_bcc, spam_flow, self_uri].hash
    end

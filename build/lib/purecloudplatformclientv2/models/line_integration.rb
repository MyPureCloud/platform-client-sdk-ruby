...
module PureCloud
  class LineIntegration
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'webhookUri')
        
        
        self.webhook_uri = attributes[:'webhookUri']
    ...
    def hash
      [id, name, channel_id, webhook_uri, status, recipient, date_created, date_modified, created_by, modified_by, version, self_uri].hash
    end

...
module PureCloud
  class CreateShareRequest
    ...
    attr_accessor :shared_entity_type

    # The entity that will be shared
    attr_accessor :shared_entity
    ...
    def self.swagger_types
      {
        ...
        :'members' => :'Array<CreateShareRequestMember>'
    ...
    def shared_entity_type=(shared_entity_type)
      allowed_values = ["DOCUMENT"]
      if shared_entity_type && !allowed_values.include?(shared_entity_type)
        fail ArgumentError, "invalid value for 'shared_entity_type', must be one of #{allowed_values}."
      end
    ...
    def member_type=(member_type)
      allowed_values = ["USER", "GROUP", "PUBLIC"]
      if member_type && !allowed_values.include?(member_type)
        fail ArgumentError, "invalid value for 'member_type', must be one of #{allowed_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          shared_entity_type == o.shared_entity_type &&
    ...
    def hash
      [shared_entity_type, shared_entity, member_type, member, members].hash
    end

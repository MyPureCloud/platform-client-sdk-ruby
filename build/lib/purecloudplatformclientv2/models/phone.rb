...
module PureCloud
  class Phone
    ...
    # Phone Base Settings
    attr_accessor :phone_base_settings

    attr_accessor :line_base_settings
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'phoneBaseSettings')
        
        
        self.phone_base_settings = attributes[:'phoneBaseSettings']
      ...
      if attributes.has_key?(:'phoneMetaBase')
        
        
        self.phone_meta_base = attributes[:'phoneMetaBase']
      ...
      if attributes.has_key?(:'secondaryStatus')
        
        
        self.secondary_status = attributes[:'secondaryStatus']
        
      
      end

      
      if attributes.has_key?(:'userAgentInfo')
        
        
        self.user_agent_info = attributes[:'userAgentInfo']
      ...
      if attributes.has_key?(:'webRtcUser')
        
        
        self.web_rtc_user = attributes[:'webRtcUser']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          site == o.site &&
          phone_base_settings == o.phone_base_settings &&
          line_base_settings == o.line_base_settings &&
          phone_meta_base == o.phone_meta_base &&
          lines == o.lines &&
          status == o.status &&
          secondary_status == o.secondary_status &&
          user_agent_info == o.user_agent_info &&
          properties == o.properties &&
          capabilities == o.capabilities &&
          web_rtc_user == o.web_rtc_user &&
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, site, phone_base_settings, line_base_settings, phone_meta_base, lines, status, secondary_status, user_agent_info, properties, capabilities, web_rtc_user, primary_edge, secondary_edge, self_uri].hash
    end

...
module PureCloud
  class ExtensionPool
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'endNumber')
        
        
        self.end_number = attributes[:'endNumber']
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, start_number, end_number, self_uri].hash
    end

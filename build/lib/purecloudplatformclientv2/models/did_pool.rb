...
module PureCloud
  class DIDPool
    ...
    def provider=(provider)
      allowed_values = ["PURE_CLOUD", "PURE_CLOUD_VOICE"]
      if provider && !allowed_values.include?(provider)
        fail ArgumentError, "invalid value for 'provider', must be one of #{allowed_values}."
      end
      @provider = provider
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          start_phone_number == o.start_phone_number &&
          end_phone_number == o.end_phone_number &&
          comments == o.comments &&
          provider == o.provider &&
          self_uri == o.self_uri
    end
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, start_phone_number, end_phone_number, comments, provider, self_uri].hash
    end

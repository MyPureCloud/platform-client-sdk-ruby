...
module PureCloud
  class QueueConversationSocialExpressionEventTopicErrorDetails
    ...
    def hash
      [status, code, message, message_with_params, message_params, context_id, uri, additional_properties].hash
    end

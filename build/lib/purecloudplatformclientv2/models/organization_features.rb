...
module PureCloud
  class OrganizationFeatures
    attr_accessor :realtime_cic

    attr_accessor :purecloud

    attr_accessor :hipaa

    attr_accessor :uc_enabled

    attr_accessor :pci

    attr_accessor :purecloud_voice

    attr_accessor :xmpp_federation

    attr_accessor :chat

    attr_accessor :informal_photos

    attr_accessor :directory

    attr_accessor :contact_center

    attr_accessor :unified_communications

    attr_accessor :custserv
    ...
    def ==(o)
      ...
      self.class == o.class &&
          realtime_cic == o.realtime_cic &&
          purecloud == o.purecloud &&
          hipaa == o.hipaa &&
          uc_enabled == o.uc_enabled &&
          pci == o.pci &&
          purecloud_voice == o.purecloud_voice &&
          xmpp_federation == o.xmpp_federation &&
          chat == o.chat &&
          informal_photos == o.informal_photos &&
          directory == o.directory &&
          contact_center == o.contact_center &&
          unified_communications == o.unified_communications &&
          custserv == o.custserv
    end

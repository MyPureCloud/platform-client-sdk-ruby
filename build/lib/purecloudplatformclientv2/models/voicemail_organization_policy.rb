...
module PureCloud
  class VoicemailOrganizationPolicy
    ...
    attr_accessor :pin_configuration

    # The extension for voicemail retrieval.  The default value is *86.
    attr_accessor :voicemail_extension
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pin_configuration == o.pin_configuration &&
          voicemail_extension == o.voicemail_extension &&
    ...
    def hash
      [enabled, alert_timeout_seconds, pin_configuration, voicemail_extension, pin_required, send_email_notifications, modified_date].hash
    end

...
module PureCloud
  class ConversationChat
    ...
    def hash
      [state, id, room_id, recording_id, segments, held, direction, disconnect_type, start_hold_time, start_alerting_time, connected_time, disconnected_time, provider, script_id, peer_id, avatar_image_url, journey_context, wrapup, after_call_work].hash
    end

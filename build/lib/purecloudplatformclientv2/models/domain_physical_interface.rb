...
module PureCloud
  class DomainPhysicalInterface
    ...
    attr_accessor :physical_capabilities
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'portLabel')
        
        
        self.port_label = attributes[:'portLabel']
        
      
      end

      
      if attributes.has_key?(:'physicalCapabilities')
        
        
        self.physical_capabilities = attributes[:'physicalCapabilities']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          physical_capabilities == o.physical_capabilities &&
          self_uri == o.self_uri
    end
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, edge_uri, friendly_name, hardware_address, port_label, physical_capabilities, self_uri].hash
    end

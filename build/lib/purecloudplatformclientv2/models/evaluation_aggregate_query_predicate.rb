...
module PureCloud
  class EvaluationAggregateQueryPredicate
    ...
    def valid?
      ...
      allowed_values = ["calibrationId", "contextId", "conversationId", "divisionId", "evaluationId", "evaluatorId", "formId", "queueId", "rescind", "userId"]

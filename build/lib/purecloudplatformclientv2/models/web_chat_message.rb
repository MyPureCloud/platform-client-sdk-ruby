...
module PureCloud
  class WebChatMessage
    ...
    def valid?
      ...
      if @body_type && !allowed_values.include?(@body_type)
        return false
      end
    ...
    # @param [Object] body_type Object to be assigned
    def body_type=(body_type)
      allowed_values = ["standard", "notice", "member-join", "member-leave", "media-request"]
      if body_type && !allowed_values.include?(body_type)
        fail ArgumentError, "invalid value for 'body_type', must be one of #{allowed_values}."
      end
      @body_type = body_type
    end
    ...
    def hash
      [id, name, conversation, sender, body, body_type, timestamp, self_uri].hash
    end

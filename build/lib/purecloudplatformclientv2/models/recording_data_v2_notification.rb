...
module PureCloud
  class RecordingDataV2Notification
    ...
    attr_accessor :duration_millieconds
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'durationMillieconds')
        
        
        self.duration_millieconds = attributes[:'durationMillieconds']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          self_uri == o.self_uri &&
          duration_millieconds == o.duration_millieconds &&
    ...
    def hash
      [id, name, date_created, date_modified, workspace, created_by, content_type, content_length, filename, change_number, date_uploaded, uploaded_by, lock_info, self_uri, duration_millieconds, conversation, read].hash
    end

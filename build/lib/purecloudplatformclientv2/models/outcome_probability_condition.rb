...
module PureCloud
  class OutcomeProbabilityCondition
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'outcomeId')
        
        
        self.outcome_id = attributes[:'outcomeId']
        
      
      end

      
      if attributes.has_key?(:'maximumProbability')
        
        
        self.maximum_probability = attributes[:'maximumProbability']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          maximum_probability == o.maximum_probability &&
    ...
    def hash
      [outcome_id, maximum_probability, probability].hash
    end

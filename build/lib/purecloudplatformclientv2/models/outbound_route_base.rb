...
module PureCloud
  class OutboundRouteBase
    ...
    attr_accessor :classification_types
    ...
    attr_accessor :external_trunk_bases
    ...
    def distribution=(distribution)
      allowed_values = ["SEQUENTIAL", "RANDOM"]
      if distribution && !allowed_values.include?(distribution)
        fail ArgumentError, "invalid value for 'distribution', must be one of #{allowed_values}."
      end
      @distribution = distribution
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          classification_types == o.classification_types &&
          enabled == o.enabled &&
          distribution == o.distribution &&
          external_trunk_bases == o.external_trunk_bases &&
          self_uri == o.self_uri
    end
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, classification_types, enabled, distribution, external_trunk_bases, self_uri].hash
    end

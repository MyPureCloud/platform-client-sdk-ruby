...
module PureCloud
  class ConversationMessageEventTopicMessageMediaParticipant
    attr_accessor :id
    ...
    def self.swagger_types
      {
        ...
        :'messages' => :'Array<ConversationMessageEventTopicMessageDetails>',

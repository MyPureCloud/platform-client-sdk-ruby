...
module PureCloud
  class DialerRulesetConfigChangeDataActionConditionPredicate
    attr_accessor :output_field

    attr_accessor :output_operator
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'outputField')
        
        
        self.output_field = attributes[:'outputField']
        
      
      end

      
      if attributes.has_key?(:'outputOperator')
        
        
        self.output_operator = attributes[:'outputOperator']
        
      
      end

      
      if attributes.has_key?(:'comparisonValue')
    ...
    def valid?
      ...
      if @output_operator && !allowed_values.include?(@output_operator)
        return false
      end
    ...
    # @param [Object] output_operator Object to be assigned
    def output_operator=(output_operator)
      allowed_values = ["EQUALS", "LESS_THAN", "LESS_THAN_EQUALS", "GREATER_THAN", "GREATER_THAN_EQUALS", "CONTAINS", "BEGINS_WITH", "ENDS_WITH", "BEFORE", "AFTER"]
      if output_operator && !allowed_values.include?(output_operator)
        fail ArgumentError, "invalid value for 'output_operator', must be one of #{allowed_values}."
      end

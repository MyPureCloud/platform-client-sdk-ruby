...
module PureCloud
  class RoutingStatusAlert
    ...
    def hash
      [id, name, agent, routing_status, routing_limit_in_seconds, rule_id, start_date, end_date, notification_users, alert_types, self_uri].hash
    end

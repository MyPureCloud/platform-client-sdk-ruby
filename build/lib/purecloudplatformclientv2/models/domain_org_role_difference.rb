...
module PureCloud
  class DomainOrgRoleDifference
    attr_accessor :removed_permission_policies

    attr_accessor :added_permission_policies

    attr_accessor :same_permission_policies

    attr_accessor :user_org_role

    attr_accessor :role_from_default
    ...
    def ==(o)
      ...
      self.class == o.class &&
          removed_permission_policies == o.removed_permission_policies &&
          added_permission_policies == o.added_permission_policies &&
          same_permission_policies == o.same_permission_policies &&
          user_org_role == o.user_org_role &&
          role_from_default == o.role_from_default
    end
    ...
    def hash
      [removed_permission_policies, added_permission_policies, same_permission_policies, user_org_role, role_from_default].hash
    end

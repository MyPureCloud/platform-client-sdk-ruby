...
module PureCloud
  class QueueConversationSocialExpressionEventTopicScreenshare
    ...
    def hash
      [state, _self, id, context, sharing, provider, script_id, peer_id, disconnect_type, connected_time, disconnected_time, wrapup, after_call_work, after_call_work_required, additional_properties].hash
    end

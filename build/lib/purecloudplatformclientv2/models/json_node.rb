...
module PureCloud
  class JsonNode
    ...
    def hash
      [array, null, node_type, object, boolean, number, float, container_node, missing_node, pojo, integral_number, floating_point_number, short, int, long, double, big_decimal, big_integer, textual, binary, value_node].hash
    end

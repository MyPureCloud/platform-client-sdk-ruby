...
module PureCloud
  class JsonNode
    ...
    def hash
      [array, null, node_type, object, boolean, number, float, missing_node, integral_number, short, pojo, value_node, container_node, floating_point_number, int, long, double, big_decimal, big_integer, textual, binary].hash
    end

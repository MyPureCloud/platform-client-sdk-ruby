...
module PureCloud
  class JsonNode
    ...
    def hash
      [node_type, float, number, boolean, object, value_node, pojo, container_node, missing_node, floating_point_number, integral_number, short, int, long, double, big_decimal, big_integer, textual, binary, array, null].hash
    end

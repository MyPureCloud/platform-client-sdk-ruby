...
module PureCloud
  class JsonNode
    ...
    def hash
      [array, null, node_type, float, boolean, number, object, integral_number, short, int, long, double, big_decimal, big_integer, textual, binary, pojo, floating_point_number, value_node, container_node, missing_node].hash
    end

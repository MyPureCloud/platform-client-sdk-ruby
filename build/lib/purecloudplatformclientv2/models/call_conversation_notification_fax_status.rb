...
module PureCloud
  class CallConversationNotificationFaxStatus
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dataRate')
        
        
        self.data_rate = attributes[:'dataRate']
    ...
    def hash
      [direction, expected_pages, active_page, lines_transmitted, bytes_transmitted, data_rate, page_errors, line_errors].hash
    end

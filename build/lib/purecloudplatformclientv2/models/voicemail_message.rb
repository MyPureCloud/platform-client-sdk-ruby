...
module PureCloud
  class VoicemailMessage
    ...
    def hash
      [id, conversation, read, audio_recording_duration_seconds, audio_recording_size_bytes, created_date, modified_date, caller_address, caller_name, caller_user, deleted, note, user, group, copied_from, copied_to, self_uri].hash
    end

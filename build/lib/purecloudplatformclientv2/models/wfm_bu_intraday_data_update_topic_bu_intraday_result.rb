...
module PureCloud
  class WfmBuIntradayDataUpdateTopicBuIntradayResult
    ...
    def self.swagger_types
      {
        ...
        :'intraday_data_groupings' => :'Array<WfmBuIntradayDataUpdateTopicBuIntradayDataGroup>',
    ...
    def hash
      [start_date, end_date, interval_length_minutes, intraday_data_groupings, categories, no_data_reason, schedule, short_term_forecast].hash
    end

...
module PureCloud
  class LocationAddressVerificationDetails
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dateFinished')
        
        
        self.date_finished = attributes[:'dateFinished']
    ...
    def hash
      [status, date_finished, date_started, service].hash
    end

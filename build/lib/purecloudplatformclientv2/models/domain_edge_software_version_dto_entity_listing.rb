...
module PureCloud
  class DomainEdgeSoftwareVersionDtoEntityListing
    ...
    def self.swagger_types
      {
        ...
        :'entities' => :'Array<DomainEdgeSoftwareVersionDto>',
    ...
    def hash
      [entities, page_size, page_number, total, self_uri, next_uri, previous_uri, last_uri, first_uri, page_count].hash
    end

...
module PureCloud
  class EdgeLine
    ...
    attr_accessor :logical_interface_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'logicalInterfaceId')
        
        
        self.logical_interface_id = attributes[:'logicalInterfaceId']
    ...
    def line_type=(line_type)
      allowed_values = ["TIE", "NETWORK", "TRUNK", "STATION"]
      if line_type && !allowed_values.include?(line_type)
        fail ArgumentError, "invalid value for 'line_type', must be one of #{allowed_values}."
      end
      @line_type = line_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          logical_interface_id == o.logical_interface_id &&
          self_uri == o.self_uri
    end

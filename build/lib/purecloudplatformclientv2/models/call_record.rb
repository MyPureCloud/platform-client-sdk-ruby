...
module PureCloud
  class CallRecord
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lastAttempt')
        
        
        self.last_attempt = attributes[:'lastAttempt']
        
      
      end

      
      if attributes.has_key?(:'lastResult')
        
        
        self.last_result = attributes[:'lastResult']

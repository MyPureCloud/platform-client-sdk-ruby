...
module PureCloud
  class OutboundRoute
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, classification_types, enabled, distribution, external_trunk_bases, site, managed, self_uri].hash
    end

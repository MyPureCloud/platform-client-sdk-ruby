...
module PureCloud
  class UserRoutingStatusNotificationErrorInfo
    ...
    attr_accessor :user_params_message
    ...
    def self.swagger_types
      {
        ...
        :'user_params' => :'Array<UserRoutingStatusNotificationErrorInfoUserParams>'
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user_params_message == o.user_params_message &&
          user_params == o.user_params
    end
    ...
    def hash
      [error_code, status, correlation_id, user_message, user_params_message, user_params].hash
    end

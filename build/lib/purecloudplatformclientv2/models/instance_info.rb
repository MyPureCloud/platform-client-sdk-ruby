...
module PureCloud
  class InstanceInfo
    ...
    attr_accessor :assigned_phone_count
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'assignedPhoneCount')
        
        
        self.assigned_phone_count = attributes[:'assignedPhoneCount']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          state == o.state &&
          edge == o.edge &&
          assigned_phone_count == o.assigned_phone_count &&
          ami == o.ami
    end
    ...
    def hash
      [id, state, edge, assigned_phone_count, ami].hash
    end

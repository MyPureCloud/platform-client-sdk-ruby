...
module PureCloud
  class GenericEventAction
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mediaAddress')
        
        
        self.media_address = attributes[:'mediaAddress']
    ...
    def valid?
      ...
      allowed_values = ["accepted", "rejected", "timedout", "errored", "missed", "ignored", "qualified", "offered"]
    ...
    def hash
      [id, state, media_type, prompt, media_address, created_date].hash
    end

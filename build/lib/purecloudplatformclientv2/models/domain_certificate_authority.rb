...
module PureCloud
  ...
  class DomainCertificateAuthority
    ...
    def self.swagger_types
      {
        ...
        :'certificate_details' => :'Array<CertificateDetails>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'certificateDetails')
        
        if (value = attributes[:'certificateDetails']).is_a?(Array)
          self.certificate_details = value
        end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          services == o.services &&
          certificate_details == o.certificate_details &&
          self_uri == o.self_uri
    end
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, certificate, type, services, certificate_details, self_uri].hash
    end

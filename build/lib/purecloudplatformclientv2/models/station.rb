...
module PureCloud
  class Station
    ...
    attr_accessor :web_rtc_media_dscp
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lineAppearanceId')
      ...
      if attributes.has_key?(:'webRtcMediaDscp')
        
        
        self.web_rtc_media_dscp = attributes[:'webRtcMediaDscp']
        
      
      end

      
      if attributes.has_key?(:'webRtcPersistentEnabled')
        
        
        self.web_rtc_persistent_enabled = attributes[:'webRtcPersistentEnabled']

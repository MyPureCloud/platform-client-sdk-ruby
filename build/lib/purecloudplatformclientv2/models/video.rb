...
module PureCloud
  class Video
    ...
    def hash
      [state, id, context, audio_muted, video_muted, sharing_screen, peer_count, disconnect_type, start_alerting_time, connected_time, disconnected_time, provider, peer_id, msids, _self, wrapup, after_call_work].hash
    end

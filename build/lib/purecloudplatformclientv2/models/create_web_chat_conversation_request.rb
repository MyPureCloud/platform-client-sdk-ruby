...
module PureCloud
  class CreateWebChatConversationRequest
    ...
    attr_accessor :member_auth_token
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'routingTarget')
        
        
        self.routing_target = attributes[:'routingTarget']
        
      
      end

      
      if attributes.has_key?(:'memberInfo')
        
        
        self.member_info = attributes[:'memberInfo']
        
      
      end

      
      if attributes.has_key?(:'memberAuthToken')
        
        
        self.member_auth_token = attributes[:'memberAuthToken']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          member_auth_token == o.member_auth_token &&
    ...
    def hash
      [organization_id, deployment_id, routing_target, member_info, member_auth_token, journey_context].hash
    end

...
module PureCloud
  class WeekScheduleGenerationResult
    ...
    def self.swagger_types
      {
        ...
        :'agent_warnings' => :'Array<ScheduleGenerationWarning>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'agentWarnings')
        
        if (value = attributes[:'agentWarnings']).is_a?(Array)
          self.agent_warnings = value
        end
      ...
      if attributes.has_key?(:'agentWarningCount')
        
        
        self.agent_warning_count = attributes[:'agentWarningCount']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          failed == o.failed &&
          run_id == o.run_id &&
          agent_warnings == o.agent_warnings &&
          agent_warning_count == o.agent_warning_count
    end
    ...
    def hash
      [failed, run_id, agent_warnings, agent_warning_count].hash
    end

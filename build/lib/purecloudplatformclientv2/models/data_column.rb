...
module PureCloud
  class DataColumn
    ...
    attr_accessor :data_column_type
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dataColumnType')
        
        
        self.data_column_type = attributes[:'dataColumnType']
    ...
    def valid?
      ...
      if @data_column_type && !allowed_values.include?(@data_column_type)
        return false
      end
    ...
    # @param [Object] data_column_type Object to be assigned
    def data_column_type=(data_column_type)
      allowed_values = ["INTERVAL_START", "INTERVAL_END", "INTERVAL_COMPLETE", "MEDIA_TYPE", "QUEUE_ID", "QUEUE_NAME", "OFFER", "ANSWER", "ANSWER_PERCENT", "ABANDON", "ABANDON_PERCENT", "TIME_TO_ABANDON", "ASA", "SERVICE_LEVEL_PERCENT", "SLA_LEVEL_PERCENT_TARGET", "AVERAGE_HANDLE", "TOTAL_HANDLE", "AVERAGE_TALK", "TOTAL_TALK", "AVERAGE_HOLD", "TOTAL_HOLD", "AVERAGE_ACW", "TOTAL_ACW", "HOLD", "TRANSFER", "TRANSFER_PERCENT", "FLOW_OUT", "HANDLE", "AVERAGE_WAIT"]
      if data_column_type && !allowed_values.include?(data_column_type)
        fail ArgumentError, "invalid value for 'data_column_type', must be one of #{allowed_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          data_column_type == o.data_column_type
    end
    ...
    def hash
      [column_name, data_column_type].hash
    end

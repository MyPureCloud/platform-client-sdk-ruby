...
module PureCloud
  class ShiftTradeMatchReviewResponse
    ...
    attr_accessor :admin_review_violations
    ...
    def self.swagger_types
      {
        ...
        :'violations' => :'Array<ShiftTradeMatchViolation>',
        
        :'admin_review_violations' => :'Array<ShiftTradeMatchViolation>'
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'violations')
      ...
      if attributes.has_key?(:'adminReviewViolations')
        
        if (value = attributes[:'adminReviewViolations']).is_a?(Array)
          self.admin_review_violations = value
        end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          admin_review_violations == o.admin_review_violations
    end
    ...
    def hash
      [initiating_user, receiving_user, violations, admin_review_violations].hash
    end

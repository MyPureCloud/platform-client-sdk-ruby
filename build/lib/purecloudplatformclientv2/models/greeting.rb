...
module PureCloud
  class Greeting
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'audioFile')
        
        
        self.audio_file = attributes[:'audioFile']
    ...
    def hash
      [id, name, type, owner_type, owner, audio_file, audio_tts, created_date, created_by, modified_date, modified_by, self_uri].hash
    end

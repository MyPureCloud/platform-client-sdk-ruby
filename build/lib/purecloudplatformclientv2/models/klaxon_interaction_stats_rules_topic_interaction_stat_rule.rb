...
module PureCloud
  class KlaxonInteractionStatsRulesTopicInteractionStatRule
    ...
    def self.swagger_types
      {
        ...
        :'notification_users' => :'Array<KlaxonInteractionStatsRulesTopicNotificationUser>',
    ...
    def hash
      [id, name, dimension, dimension_value, dimension_value_name, metric, media_type, numeric_range, statistic, value, in_alarm, enabled, notification_users, alert_types].hash
    end

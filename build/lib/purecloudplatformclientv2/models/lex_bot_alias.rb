...
module PureCloud
  class LexBotAlias
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'botVersion')
        
        
        self.bot_version = attributes[:'botVersion']
    ...
    def valid?
      ...
      if @language && !allowed_values.include?(@language)
        return false
      end
    ...
    def language=(language)
      allowed_values = ["en-US"]
      if language && !allowed_values.include?(language)
        fail ArgumentError, "invalid value for 'language', must be one of #{allowed_values}."
      end
      @language = language
    end
    ...
    def hash
      [id, name, bot, bot_version, status, failure_reason, language, intents, self_uri].hash
    end

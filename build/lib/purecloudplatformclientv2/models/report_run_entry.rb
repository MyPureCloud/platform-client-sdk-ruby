...
module PureCloud
  class ReportRunEntry
    ...
    attr_accessor :run_duration_msec

    attr_accessor :report_url

    attr_accessor :report_format

    attr_accessor :schedule_uri
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          run_duration_msec == o.run_duration_msec &&
          report_url == o.report_url &&
          report_format == o.report_format &&
          schedule_uri == o.schedule_uri &&
          self_uri == o.self_uri
    end
    ...
    def hash
      [id, name, report_id, run_time, run_status, error_message, run_duration_msec, report_url, report_format, schedule_uri, self_uri].hash
    end

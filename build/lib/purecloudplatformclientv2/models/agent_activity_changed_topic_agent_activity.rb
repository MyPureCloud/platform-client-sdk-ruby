...
module PureCloud
  class AgentActivityChangedTopicAgentActivity
    ...
    attr_accessor :active_queue_ids

    attr_accessor :date_active_queues_changed
    ...
    def self.swagger_types
      {
        ...
        :'routing_status' => :'AgentActivityChangedTopicRoutingStatus',
        
        :'presence' => :'AgentActivityChangedTopicPresence',
        
        :'out_of_office' => :'AgentActivityChangedTopicOutOfOffice',
        
        :'active_queue_ids' => :'Array<String>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'activeQueueIds')
        
        if (value = attributes[:'activeQueueIds']).is_a?(Array)
          self.active_queue_ids = value
        end
      ...
      if attributes.has_key?(:'dateActiveQueuesChanged')
        
        
        self.date_active_queues_changed = attributes[:'dateActiveQueuesChanged']
    ...
    def hash
      [id, routing_status, presence, out_of_office, active_queue_ids, date_active_queues_changed].hash
    end

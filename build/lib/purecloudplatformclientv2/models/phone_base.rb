...
module PureCloud
  class PhoneBase
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, phone_meta_base, lines, properties, capabilities, self_uri].hash
    end

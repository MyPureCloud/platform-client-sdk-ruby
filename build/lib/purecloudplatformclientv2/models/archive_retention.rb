...
module PureCloud
  class ArchiveRetention
    ...
    def storage_medium=(storage_medium)
      allowed_values = ["CLOUDARCHIVE"]
      if storage_medium && !allowed_values.include?(storage_medium)
        fail ArgumentError, "invalid value for 'storage_medium', must be one of #{allowed_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          days == o.days &&
          storage_medium == o.storage_medium
    end

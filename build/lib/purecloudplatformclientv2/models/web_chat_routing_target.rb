...
module PureCloud
  class WebChatRoutingTarget
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'targetAddress')
        
        
        self.target_address = attributes[:'targetAddress']
    ...
    def valid?
      ...
      if @target_type && !allowed_values.include?(@target_type)
        return false
      end
    ...
    def target_type=(target_type)
      allowed_values = ["QUEUE"]
      if target_type && !allowed_values.include?(target_type)
        fail ArgumentError, "invalid value for 'target_type', must be one of #{allowed_values}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target_address == o.target_address &&
          skills == o.skills &&
          language == o.language &&
          priority == o.priority
    end
    ...
    def hash
      [target_type, target_address, skills, language, priority].hash
    end

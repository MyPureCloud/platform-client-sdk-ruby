...
module PureCloud
  class Endpoint
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, count, properties, schema, enabled, site, dids, self_uri].hash
    end

...
module PureCloud
  class FacebookIntegrationRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'userAccessToken')
        
        
        self.user_access_token = attributes[:'userAccessToken']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user_access_token == o.user_access_token &&
          page_id == o.page_id &&
          app_id == o.app_id &&
    ...
    def hash
      [id, name, page_access_token, user_access_token, page_id, app_id, app_secret, self_uri].hash
    end

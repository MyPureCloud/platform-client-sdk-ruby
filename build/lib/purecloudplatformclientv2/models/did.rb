...
module PureCloud
  class DID
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'didPool')
        
        
        self.did_pool = attributes[:'didPool']
    ...
    def hash
      [id, name, description, version, date_created, date_modified, modified_by, created_by, state, modified_by_app, created_by_app, phone_number, did_pool, owner, owner_type, self_uri].hash
    end

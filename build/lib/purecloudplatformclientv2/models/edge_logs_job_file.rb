...
module PureCloud
  class EdgeLogsJobFile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'timeCreated')
      ...
      if attributes.has_key?(:'timeModified')
        
        
        self.time_modified = attributes[:'timeModified']
      ...
      if attributes.has_key?(:'edgePath')
        
        
        self.edge_path = attributes[:'edgePath']
        
      
      end

      
      if attributes.has_key?(:'downloadId')
        
        
        self.download_id = attributes[:'downloadId']

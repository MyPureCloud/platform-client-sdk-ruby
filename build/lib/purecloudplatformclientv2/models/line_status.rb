...
module PureCloud
  class LineStatus
    ...
    attr_accessor :address_of_record
    ...
    attr_accessor :reachable_state_time
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contactAddresses')
        
        if (value = attributes[:'contactAddresses']).is_a?(Array)
      ...
      if attributes.has_key?(:'reachableStateTime')
        
        
        self.reachable_state_time = attributes[:'reachableStateTime']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          address_of_record == o.address_of_record &&
          contact_addresses == o.contact_addresses &&
          reachable_state_time == o.reachable_state_time
    end
    ...
    def hash
      [id, reachable, address_of_record, contact_addresses, reachable_state_time].hash
    end

...
module PureCloud
  class DialerSequenceScheduleConfigChangeSequenceSchedule
    ...
    def self.swagger_types
      {
        ...
        :'intervals' => :'Array<DialerSequenceScheduleConfigChangeScheduleInterval>',
    ...
    def hash
      [id, name, date_created, date_modified, version, intervals, time_zone, sequence, additional_properties].hash
    end

...
module PureCloud
  class WorkforceManagementApi
    ...
    # 
    # @param [Hash] opts the optional parameters
    # @option opts [MoveAgentsRequest] :body body
    # @return [MoveAgentsResponse]
    def post_workforcemanagement_agents(opts = {})
      data, _status_code, _headers = post_workforcemanagement_agents_with_http_info(opts)
      return data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [MoveAgentsRequest] :body body
    # @return [Array<(MoveAgentsResponse, Fixnum, Hash)>] MoveAgentsResponse data, response status code and response headers
    def post_workforcemanagement_agents_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: WorkforceManagementApi.post_workforcemanagement_agents ..."
      end
      ...
      # resource path
      local_var_path = "/api/v2/workforcemanagement/agents".sub('{format}','json')
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'MoveAgentsResponse')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WorkforceManagementApi#post_workforcemanagement_agents\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
